...
PengoActor::PengoActor()
{
	...
	m_pActor->AddComponent<AnimationComponent>(10);
	...
	m_pActor->GetComponent<AnimationComponent>()->AddData("WasInputGiven", false);
	m_pActor->GetComponent<AnimationComponent>()->AddData("WasBlockPushed", false);
	...
	m_pActor->AddComponent<GameEngine::FSM>(m_IdleState.get(), m_pActor->GetComponent<AnimationComponent>()->GetBlackboard().get());
