...
namespace ImGui
{
    ...
    IMGUI_API void          ShowMyWindow();
    IMGUI_API void          ShowWindow(const char* name, bool* p_open = NULL);
    IMGUI_API void          ShowSecondWindow(); // create Demo window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!
